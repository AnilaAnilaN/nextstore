          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="border border-gray-200 rounded p-4 mb-6">
                <h3 className="text-sm uppercase font-medium text-gray-900 mb-4">Categories</h3>
              ...
              {/* Filter by Price */}
              <div className="border border-gray-200 rounded p-4 mb-6">
                <h3 className="text-sm uppercase font-medium text-gray-900 mb-4">Filter by Price</h3>
              ...
              {/* Size Filter */}
              <div className="border border-gray-200 rounded p-4 mb-6">
                <h3 className="text-sm uppercase font-medium text-gray-900 mb-4">Size</h3>
              ...
              <div className="border border-gray-200 rounded p-4">
                <h3 className="text-sm uppercase font-medium text-gray-900 mb-4">Color</h3>
                <div className="space-y-2">
                  <Link href="#" className="flex items-center text-gray-600 hover:text-[#7971ea]">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <h2 className="text-2xl font-medium text-gray-900 mb-4 md:mb-0">Shop All</h2>
              ...
              <div className="flex justify-center">
                <ul className="flex space-x-2">
                  <li><Link href="#" className="px-3 py-2 border border-gray-300 rounded hover:bg-gray-100">&lt;</Link></li>
                  <li><Link href="#" className="px-3 py-2 bg-[#7971ea] text-white rounded">1</Link></li>
                  <li><Link href="#" className="px-3 py-2 border border-gray-300 rounded hover:bg-gray-100">2</Link></li>
                  <li><Link href="#" className="px-3 py-2 border border-gray-300 rounded hover:bg-gray-100">3</Link></li>
                  <li><Link href="#" className="px-3 py-2 border border-gray-300 rounded hover:bg-gray-100">4</Link></li>
                  <li><Link href="#" className="px-3 py-2 border border-gray-300 rounded hover:bg-gray-100">5</Link></li>
                  <li><Link href="#" className="px-3 py-2 border border-gray-300 rounded hover:bg-gray-100">&gt;</Link></li>
                </ul>
              </div>
            </div>
